var is_array = exports.is_array =function is_array (mixedVar) { // eslint-disable-line camelcase
    ...
    var iniVal = (typeof require !== 'undefined' ? ini_get('locutus.objectsAsArrays') : undefined) || 'on'
    if (iniVal === 'on') {
